    ...
    <div>
      <nav className="navbar navbar-expand-lg navbar-light bg-light custom-navbar fixed-top">
        <div className="container-fluid">
          ...
          <Link className="nav-link active" aria-current="page" to="/dashboard"> <img src={foodlogo} alt="logo" className="logo" /></Link>
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item">
                <Link className="nav-link active" aria-current="page" to="/order"> PlaceOrder </Link>
              ...
              <li className="nav-item">
                <Link className="nav-link active" aria-current="page" to="#/admindash"> Blog </Link>
