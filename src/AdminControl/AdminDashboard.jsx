              ...
              <div id="collapsePages" className="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div className="bg-white py-2 collapse-inner rounded">
                  ...
                  {/* <Link to="/" className="collapse-item" >Login</Link>
                    <button className="collapse-item" onClick={update}>Login</button>
                  ...
                  <Link to="/viewmenuitem" className="collapse-item">ViewMenuItem</Link>
                ...
                <div className="row">
                  ...
                  <div className="col-lg-6 mb-4">
                    ...
                    <div className="card shadow mb-4">
                      ...
                      <div className="card-body">
                        <p> Admin 2 makes extensive use of Bootstrap 4 utility classNamees in order to reduce
